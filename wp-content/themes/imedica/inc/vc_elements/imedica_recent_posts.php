<?php
add_action( 'vc_before_init', 'imedica_init_recent_posts' );
function imedica_init_recent_posts() {
	if ( class_exists( 'WPBakeryShortCode' ) ) {
		class WPBakeryShortCode_imedica_recent_posts extends WPBakeryShortCode {
		}
	}
	if ( function_exists( "vc_map" ) ) {
		vc_map( array(
			'name'        => __( 'Recent Posts', "imedica" ),
			'base'        => 'imedica_recent_posts',
			'category' => 'iMedica',
			'icon'  => get_template_directory_uri() . "/vc_templates/images/recent_posts.png",
			'class' => 'imd_recent_posts',
			'weight' => - 50,
			'description' => __( 'The most recent posts on your site', 'imedica' ),
			'params'      => array(
				array(
					'type'        => 'textfield',
