	...
	<div class="fw-ext-sidebars-preset-list">
		<?php if ( is_array( $created_sidebars ) ) : ?>
			<?php foreach ( $created_sidebars as $item ) : ?>
				<div class="fw-ext-sidebars-created-tab-preset"
				     data-type="<?php echo isset( $item['type'] ) ? $item['type'] : '' ?>"
				     data-preset-id="<?php echo isset( $item['preset_id'] ) ? $item['preset_id'] : '' ?>">
					...
					<span class="fw-ext-sidebars-preset-edit-span">
							...
							<span
								class="fw-ext-sidebars-desc">&nbsp;(<?php echo isset( $item['page_names'] ) ? __( 'For Specific Page', 'fw' ) : __( 'For Grouped Page', 'fw' ) ?>
								)</span>
						</span>
