...
<div id="fw-add-button"
     class="fw-col-sm-8 fw-col-sm-offset-4 fw-col-md-9 fw-col-md-offset-3 fw-col-lg-10 fw-col-lg-offset-2">
	<input id="submit-settings-<?php echo $id ?>" type="button" class="button button-primary button-large"
	       value="<?php _e( 'Save', 'fw' ) ?>"/>
