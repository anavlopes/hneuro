...
<div class="fw-ext-sidebars-box-holder" data-tab-name="specific">
		...
		<div class="fw-inner fw-row fw-backend-option-fixed-width">
			...
			<div class="fw-col-xs-8">
				<div class="ui-widget fw-border-box-sizing">
					<input id="specific-field-id" type="text" class="autocomplete-ui fw-option" name="specific-field-id"
					       placeholder="<?php echo esc_attr( __( 'Type to search ...', 'fw' ) ) ?>"/>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="fw-col-sm-8 fw-col-sm-offset-4 fw-col-md-9 fw-col-md-offset-3 fw-col-lg-10 fw-col-lg-offset-2">
		<div
			class="fw-ext-sidebars-desc"><?php _e( 'Search for a specific page you want to set a sidebar for', 'fw' ) ?></div>
	</div>
	<div class="fw-clear"></div>

	<div class="sidebars-specific-pages fw-col-sm-8 fw-col-md-9 fw-col-md-offset-3 fw-col-lg-10 fw-col-lg-offset-2">
		<!-- Here will be appear specific pages --></div>
	<div class="fw-clear"></div>
