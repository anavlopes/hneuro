...
<?php if ( ! empty( $data_positions_options['choices'] ) or $cnt_created_sidebars ) : ?>
	<div class="fw-ext-sidebars-wrap-container">
		<div class="fw-ext-sidebars-wrap">
			...
			<div
				class="fw-ext-sidebars-desc"><?php _e( 'Use this section to create and/or set different sidebar(s) for different page(s)', 'fw' ) ?></div>
			...
			<div class="fw-sidebars-tabs-wrapper" style="opacity: 0;">
				<div class="fw-sidebars-tabs-list">
					<ul>
						<?php if ( ! empty( $data_positions_options['choices'] ) ) : ?>
							<li><a href="#fw-sidebars-tab-1" class="nav-tab"><span
										class="spinner"></span><?php echo __( 'For Grouped Pages', 'fw' ); ?></a></li>
							<li><a href="#fw-sidebars-tab-2" class="nav-tab"><span
										class="spinner"></span><?php echo __( 'For Specific Pages', 'fw' ); ?></a></li>
						<?php endif ?>
						<li <?php echo $cnt_created_sidebars ? '' : 'style="display: none"'; ?> ><a
								href="#fw-sidebars-tab-3"
								class="nav-tab"><?php echo $cnt_created_sidebars . ' ' . __( 'Created', 'fw' ); ?></a>
						</li>
					</ul>
				...
				<div class="fw-sidebars-tabs">
					<div class="fw-inner">
						...
						<div id="fw-sidebars-tab-3"
						     role="tabpanel" <?php echo( $cnt_created_sidebars ? '' : 'style="display: none;"' ) ?> >
